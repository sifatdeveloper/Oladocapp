...
public class Adapter1 extends FirebaseRecyclerAdapter<Modalsub, Adapter1.ViewHolder> {
    public Adapter1(@NonNull FirebaseRecyclerOptions<Modalsub> options) {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int i, @NonNull Modalsub modalsub) {
        if ("Gynecologist".equals(modalsub.getProfession())){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view1= LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_layout,parent,false);
