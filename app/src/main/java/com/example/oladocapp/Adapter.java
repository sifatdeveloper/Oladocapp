...
public class Adapter extends FirebaseRecyclerAdapter<Modalsub,Adapter.ViewHolder> {

    public Adapter(@NonNull FirebaseRecyclerOptions<Modalsub> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int i, @NonNull Modalsub modalsub) {
        if ("Skin Specialist".equals(modalsub.getProfession())){
