...
public class AdapterOrthopedic extends FirebaseRecyclerAdapter<Modalsub,AdapterOrthopedic.ViewHolder> {
    public AdapterOrthopedic(@NonNull FirebaseRecyclerOptions<Modalsub> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int i, @NonNull Modalsub modalsub) {
        if ("Orthopedic Surgeon".equals(modalsub.getProfession())){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View orthopedic= LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_layout,parent,false);
        return new ViewHolder(orthopedic);
    }
